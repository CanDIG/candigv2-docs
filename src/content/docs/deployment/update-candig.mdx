...
1.  [Get a site admin token](/candigv2-docs/user-roles/assign-roles/#getting-an-api-token) and in a terminal session, store in a variable called `TOKEN`, store your candig domain in a variable called `CANDIG_URL` 2. Call the GET method to list all currently federated servers:
