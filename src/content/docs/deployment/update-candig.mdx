...
1. Backup your existing deployment using the steps on the page: [Backing up and restoring CanDIG data](/candigv2-docs/deployment/backup-restore-candig). This should be done regardless of wheteher you think the deployment will destroy any data, just in case anything goes wrong. Things you will want to back up are:
...
9. Run integration tests to ensure all the services are running as expected
    ...
    If tests fail, check out the [troubleshooting section](/candigv2-docs/deployment/stack-troubleshooting) or [reach out for help](https://github.com/CanDIG/candigv2-docs/issues/new/choose).
