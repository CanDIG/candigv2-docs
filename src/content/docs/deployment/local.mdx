...
If you want to use an existing conda installation on your local at the bottom of the [.env](https://github.com/CanDIG/candigv2-docs/blob/stable/etc/env/example.env), set `CONDA_INSTALL` to your existing conda installation path
