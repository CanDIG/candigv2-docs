...
For any programs the user has authorization for, they will be displayed the exact number of donors matching the query as well as the full list of donors that match the query.
